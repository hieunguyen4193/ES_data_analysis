---
title: "Update analysis on the two samples d4_LPS d4_SPF: removing T/B cells"
author:
...
if (file.exists(file.path(path.to.08.output, sprintf("cluster_markers_subclusters_%s.rds", sub.cluster.id))) == FALSE){
  ...
  saveRDS(cluster.markers, file.path(path.to.08.output, sprintf("cluster_markers_subclusters_%s.rds", sub.cluster.id)))
} else {
  cluster.markers <- readRDS(file.path(path.to.08.output, sprintf("cluster_markers_subclusters_%s.rds", sub.cluster.id)))
}
```
...
if (file.exists(file.path(path.to.08.output, sprintf("high.ambientRNA.markers_%s.rds", sub.cluster.id))) == FALSE){
  ...
  saveRDS(high.ambientRNA.markers.raw, file.path(path.to.08.output, sprintf("high.ambientRNA.markers_%s.raw.rds", sub.cluster.id)))
  saveRDS(high.ambientRNA.markers, file.path(path.to.08.output, sprintf("high.ambientRNA.markers_%s.rds", sub.cluster.id)))
} else {
  high.ambientRNA.markers <- readRDS(file.path(path.to.08.output, sprintf("high.ambientRNA.markers_%s.rds", sub.cluster.id)))
  high.ambientRNA.markers.raw <- readRDS(file.path(path.to.08.output, sprintf("high.ambientRNA.markers_%s.raw.rds", sub.cluster.id)))
}
