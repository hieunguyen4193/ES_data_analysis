...
if (file.exists(file.path(path.to.08.output, sprintf("%s.remove_contam_T_B_cells.ambientRNAonly.rds", sub.cluster.id))) == FALSE){
  ...
  saveRDS(s.obj.ambientRNA, file.path(path.to.04.output, sprintf("%s.remove_contam_T_B_cells.ambientRNAonly.rds", sub.cluster.id)))
  
} else {
  s.obj.ambientRNA <- readRDS(file.path(path.to.04.output, sprintf("%s.remove_contam_T_B_cells.ambientRNAonly.rds", sub.cluster.id)))
}
```
