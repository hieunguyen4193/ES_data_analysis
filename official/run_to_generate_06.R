...
path.to.rmd <- file.path(path.to.main.src, src.dir, "06_analysis_after_integration_with_cellcecyle_correction.Rmd")
output_dir <- file.path(path.to.save.html, "06_output")
