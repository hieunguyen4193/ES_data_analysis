...
# path.to.save.output <- file.path("/media/hieunguyen/CRC1382H/CRC1382/outdir/EStange_20240411_reduced_RNAcontam_0/data_analysis/13_output/all.samples/adult_SPF_d7_SPF", cluster.id) 
