---
title: "Analysis on the integrated dataset, integration: `r params$integration.case`, regression: `r params$regression.mode`, filter by `r params$filter.mode`, sub-cluster: `r params$subcluster.name`"
author:
...
path.to.main.input <- file.path(outdir, PROJECT)
path.to.main.output <- file.path(outdir, PROJECT, "data_analysis")
# path.to.10.output <- file.path(path.to.main.output2, "10_output", integration.case, regression.mode, filter.mode, subcluster.name)
