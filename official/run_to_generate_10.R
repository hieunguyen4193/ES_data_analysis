...
src.dir <- "10_filter_TCR_BCR_genes_in_PCA_UMAP_only"
path.to.rmd <- file.path(path.to.main.src, src.dir, "10_downstream_analysis.Rmd")
output_dir <- file.path(path.to.save.html, "10_output")
