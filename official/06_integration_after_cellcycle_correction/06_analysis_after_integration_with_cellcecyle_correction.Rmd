---
title: "Analysis on the integrated dataset, case: `r params$input.case`, regression mode `r params$regression.mode`"
author:
...
path.to.06.output <- file.path(path.to.main.output, "06_output", input.case, regression.mode)
dir.create(path.to.06.output, showWarnings = FALSE, recursive = TRUE)

path.to.s.obj <- file.path(path.to.06.output, "s8_output", sprintf("%s.output.s8.rds", PROJECT))
