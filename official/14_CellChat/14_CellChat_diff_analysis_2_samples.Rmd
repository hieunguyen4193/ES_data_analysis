...
# path.to.s.obj <-"/media/hieunguyen/CRC1382H/CRC1382/outdir/Estange_20240411_reduced_RNAcontam_0/data_analysis/12_output_remove_BCR_TCR/remove_d4_LPS_SC5/CC_differences/nCount_and_BCR_TCRgenes/myeloid/s8_output/EStange_20240411_reduced_RNAcontam_0.output.s8.rds"
# sample1 <- "adult_SPF"
# path.to.cellchat1 <-"/media/hieunguyen/CRC1382H/CRC1382/outdir/EStange_20240411_reduced_RNAcontam_0/data_analysis/14_output/from_12_output_remove_BCR_TCR/remove_d4_LPS_SC5/CC_differences/nCount_and_BCR_TCRgenes/myeloid/adult_SPF/part1/CellChat_object.adult_SPF.Filter10.rds"
# sample2 <- "adult_GF"
# path.to.cellchat2 <- "/media/hieunguyen/CRC1382H/CRC1382/outdir/EStange_20240411_reduced_RNAcontam_0/data_analysis/14_output/from_12_output_remove_BCR_TCR/remove_d4_LPS_SC5/CC_differences/nCount_and_BCR_TCRgenes/myeloid/adult_GF/part1/CellChat_object.adult_GF.Filter10.rds"
# path.to.save.output <- "/media/hieunguyen/CRC1382H/CRC1382/outdir/EStange_20240411_reduced_RNAcontam_0/data_analysis/14_output/compare_2_samples/from_12_output_remove_BCR_TCR/remove_d4_LPS_SC5/CC_differences/nCount_and_BCR_TCRgenes/myeloid/adult_SPF_vs_adult_GF"
...
for (pathway.show in all.pathways){
  ...
  tryCatch({
    gg1 <- netVisual_bubble(cellchat, 
                            comparison = c(1, 2), 
                            max.dataset = 1, 
                            title.name = sprintf("Increased signaling in %s", sample1), 
                          angle.x = 90, 
                          remove.isolate = T, 
